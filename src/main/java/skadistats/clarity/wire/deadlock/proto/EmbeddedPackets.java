...
public class EmbeddedPackets {
    ...
    static {
        ...
        /* 304 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_TeamRewards_VALUE, CitadelUserMessages.CCitadelUserMsg_TeamRewards.class);
        ...
        /* 310 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_RecentDamageSummary_VALUE, CitadelUserMessages.CCitadelUserMsg_RecentDamageSummary.class);
        /* 311 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_SpectatorTeamChanged_VALUE, CitadelUserMessages.CCitadelUserMsg_SpectatorTeamChanged.class);
        ...
        /* 313 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_GoldHistory_VALUE, CitadelUserMessages.CCitadelUserMsg_GoldHistory.class);
        ...
        /* 315 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_QuickResponse_VALUE, CitadelUserMessages.CCitadelUserMsg_QuickResponse.class);
        ...
        /* 318 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_AbilityInterrupted_VALUE, CitadelUserMessages.CCitadelUserMsg_AbilityInterrupted.class);
        ...
        /* 320 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_ReturnIdol_VALUE, CitadelUserMessages.CCitadelUserMsg_ReturnIdol.class);
        /* 321 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_SetClientCameraAngles_VALUE, CitadelUserMessages.CCitadelUserMsg_SetClientCameraAngles.class);
        /* 322 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_MapLine_VALUE, CitadelUserMessages.CCitadelUserMsg_MapLine.class);
        /* 323 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_BulletHit_VALUE, CitadelUserMessages.CCitadelUserMessage_BulletHit.class);
        /* 324 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_ObjectiveMask_VALUE, CitadelUserMessages.CCitadelUserMessage_ObjectiveMask.class);
        /* 325 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_ModifierApplied_VALUE, CitadelUserMessages.CCitadelUserMessage_AuraModifierApplied.class);
        ...
        /* 327 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_AuraModifierApplied_VALUE, CitadelUserMessages.CCitadelUserMessage_AuraModifierApplied.class);
        /* 329 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_ObstructedShotFired_VALUE, CitadelUserMessages.CCitadelUserMsg_ObstructedShotFired.class);
        /* 330 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_AbilityLateFailure_VALUE, CitadelUserMessages.CCitadelUserMsg_AbilityLateFailure.class);
        /* 331 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_AbilityPing_VALUE, CitadelUserMessages.CCitadelUserMsg_AbilityPing.class);
        ...
        /* 333 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_DeathReplayData_VALUE, CitadelUserMessages.CCitadelUserMsg_DeathReplayData.class);
        /* 334 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_PlayerLifetimeStatInfo_VALUE, CitadelUserMessages.CCitadelUserMsg_PlayerLifetimeStatInfo.class);
        /* 336 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_ForceShopClosed_VALUE, CitadelUserMessages.CCitadelUserMsg_ForceShopClosed.class);
        /* 337 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_StaminaDrained_VALUE, CitadelUserMessages.CCitadelUserMsg_StaminaDrained.class);
        ...
        /* 339 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_GetDamageStatsResponse_VALUE, CitadelUserMessages.CCitadelUserMsg_GetDamageStatsResponse.class);
        ...
        /* 345 */ K2C.put(DeadlockMessageId.CitadelUserMessageIds.k_EUserMsg_CurrencyChanged_VALUE, CitadelUserMessages.CCitadelUserMessage_CurrencyChanged.class);
